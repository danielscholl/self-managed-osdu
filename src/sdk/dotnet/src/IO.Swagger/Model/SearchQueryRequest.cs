...
namespace IO.Swagger.Model
{
    ...
    public partial class SearchQueryRequest :  IEquatable<SearchQueryRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SearchQueryRequest" /> class.
        /// </summary>
        /// <param name="offset">The starting offset from which to return results.</param>
        ...
        public SearchQueryRequest(int? offset = default(int?), string kind = default(string), int? limit = default(int?), string query = default(string), SearchSpatialFilter spatialFilter = default(SearchSpatialFilter), List<string> returnedFields = default(List<string>))
        {
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new InvalidDataException("kind is a required property for SearchQueryRequest and cannot be null");
            }
            else
            {
                this.Kind = kind;
        ...
        /// </summary>
        /// <value>The starting offset from which to return results</value>
