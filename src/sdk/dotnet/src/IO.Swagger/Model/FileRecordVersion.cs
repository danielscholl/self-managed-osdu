...
namespace IO.Swagger.Model
{
    ...
    public partial class FileRecordVersion :  IEquatable<FileRecordVersion>, IValidatableObject
    {
        ...
        public FileRecordVersion(string kind = default(string), FileAcl acl = default(FileAcl), FileLegal legal = default(FileLegal), Files data = default(Files), FileLinkList ancestry = default(FileLinkList), long? version = default(long?))
        {
            this.Kind = kind;
            this.Acl = acl;
            this.Legal = legal;
