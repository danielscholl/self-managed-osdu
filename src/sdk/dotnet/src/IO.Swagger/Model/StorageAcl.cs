...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageAcl :  IEquatable<StorageAcl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageAcl" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StorageAcl() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageAcl" /> class.
        /// </summary>
        ...
        public StorageAcl(List<string> viewers = default(List<string>), List<string> owners = default(List<string>))
        {
            // to ensure "viewers" is required (not null)
            if (viewers == null)
            {
                throw new InvalidDataException("viewers is a required property for StorageAcl and cannot be null");
            }
            else
            {
            ...
            if (owners == null)
            {
                throw new InvalidDataException("owners is a required property for StorageAcl and cannot be null");
            }
            else
            {
                this.Owners = owners;
        ...
        {
            return this.Equals(input as StorageAcl);
        }

        /// <summary>
        /// Returns true if StorageAcl instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageAcl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageAcl input)
        {
            if (input == null)
                return false;
