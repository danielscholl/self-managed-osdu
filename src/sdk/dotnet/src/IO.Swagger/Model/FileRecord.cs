...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FileRecord :  IEquatable<FileRecord>, IValidatableObject
    {
        /// <summary>
        ...
        public FileRecord(string kind = default(string), FileAcl acl = default(FileAcl), FileLegal legal = default(FileLegal), Files data = default(Files), FileLinkList ancestry = default(FileLinkList))
        {
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new InvalidDataException("kind is a required property for FileRecord and cannot be null");
            }
            else
            {
                this.Kind = kind;
            ...
            if (acl == null)
            {
                throw new InvalidDataException("acl is a required property for FileRecord and cannot be null");
            }
            else
            {
                this.Acl = acl;
            ...
            if (legal == null)
            {
                throw new InvalidDataException("legal is a required property for FileRecord and cannot be null");
            }
            else
            {
                this.Legal = legal;
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for FileRecord and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public FileLinkList Ancestry { get; set; }
        ...
        {
            return this.Equals(input as FileRecord);
        }

        /// <summary>
        /// Returns true if FileRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of FileRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileRecord input)
        {
            if (input == null)
                return false;
