...
namespace OsduClient.Api
{
    ...
    public interface IFileServiceApi : IApiAccessor
    {
        ...
        ApiResponse<FileMetadataResponse> PublishFileMetadataForAFile_WithHttpInfo (string dataPartitionId, FileMetadata body = null);
        ...
        System.Threading.Tasks.Task<FileMetadataResponse> PublishFileMetadataForAFile_Async (string dataPartitionId, FileMetadata body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<FileMetadataResponse>> PublishFileMetadataForAFile_AsyncWithHttpInfo (string dataPartitionId, FileMetadata body = null);
    ...
    public partial class FileServiceApi : IFileServiceApi
    {
        ...
        /// <returns></returns>
        public FileServiceApi(OsduClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body">File metadata content (optional)</param>
        /// <returns>FileMetadataResponse</returns>
        public FileMetadataResponse PublishFileMetadataForAFile_ (string dataPartitionId, FileMetadata body = null)
        {
        ...
        /// <param name="body">File metadata content (optional)</param>
        /// <returns>ApiResponse of FileMetadataResponse</returns>
        public ApiResponse< FileMetadataResponse > PublishFileMetadataForAFile_WithHttpInfo (string dataPartitionId, FileMetadata body = null)
        {
            // verify the required parameter 'dataPartitionId' is set
            if (dataPartitionId == null)
        ...
        /// <param name="body">File metadata content (optional)</param>
        /// <returns>Task of FileMetadataResponse</returns>
        public async System.Threading.Tasks.Task<FileMetadataResponse> PublishFileMetadataForAFile_Async (string dataPartitionId, FileMetadata body = null)
        {
        ...
        /// <param name="body">File metadata content (optional)</param>
        /// <returns>Task of ApiResponse (FileMetadataResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FileMetadataResponse>> PublishFileMetadataForAFile_AsyncWithHttpInfo (string dataPartitionId, FileMetadata body = null)
        {
            // verify the required parameter 'dataPartitionId' is set
            if (dataPartitionId == null)
                throw new ApiException(400, "Missing required parameter 'dataPartitionId' when calling FileServiceApi->PublishFileMetadataForAFile_");
