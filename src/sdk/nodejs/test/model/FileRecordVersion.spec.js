...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileRecordVersion', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.FileRecordVersion();
      });

      it('should create an instance of FileRecordVersion', function() {
        // TODO: update the code to test FileRecordVersion
        expect(instance).to.be.a(SelfManagedOsdu.FileRecordVersion);
      });
