...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SchemaError', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.SchemaError();
      });

      it('should create an instance of SchemaError', function() {
        // TODO: update the code to test SchemaError
        expect(instance).to.be.a(SelfManagedOsdu.SchemaError);
      });
