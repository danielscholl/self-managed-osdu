...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StorageQueryResponse', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.StorageQueryResponse();
      });

      it('should create an instance of StorageQueryResponse', function() {
        // TODO: update the code to test StorageQueryResponse
        expect(instance).to.be.a(SelfManagedOsdu.StorageQueryResponse);
      });
