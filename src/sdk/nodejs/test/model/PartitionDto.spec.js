...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartitionDto', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.PartitionDto();
      });

      it('should create an instance of PartitionDto', function() {
        // TODO: update the code to test PartitionDto
        expect(instance).to.be.a(SelfManagedOsdu.PartitionDto);
      });
