...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StorageAcl', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.StorageAcl();
      });

      it('should create an instance of StorageAcl', function() {
        // TODO: update the code to test StorageAcl
        expect(instance).to.be.a(SelfManagedOsdu.StorageAcl);
      });
