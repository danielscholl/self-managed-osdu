...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LegalTagDto', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.LegalTagDto();
      });

      it('should create an instance of LegalTagDto', function() {
        // TODO: update the code to test LegalTagDto
        expect(instance).to.be.a(SelfManagedOsdu.LegalTagDto);
      });
