...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StorageLegal', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.StorageLegal();
      });

      it('should create an instance of StorageLegal', function() {
        // TODO: update the code to test StorageLegal
        expect(instance).to.be.a(SelfManagedOsdu.StorageLegal);
      });
