...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FileAncestry', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.FileAncestry();
      });

      it('should create an instance of FileAncestry', function() {
        // TODO: update the code to test FileAncestry
        expect(instance).to.be.a(SelfManagedOsdu.FileAncestry);
      });
