...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegisterRecord', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.RegisterRecord();
      });

      it('should create an instance of RegisterRecord', function() {
        // TODO: update the code to test RegisterRecord
        expect(instance).to.be.a(SelfManagedOsdu.RegisterRecord);
      });
