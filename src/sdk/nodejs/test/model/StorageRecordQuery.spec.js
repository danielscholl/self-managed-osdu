...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StorageRecordQuery', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.StorageRecordQuery();
      });

      it('should create an instance of StorageRecordQuery', function() {
        // TODO: update the code to test StorageRecordQuery
        expect(instance).to.be.a(SelfManagedOsdu.StorageRecordQuery);
      });
