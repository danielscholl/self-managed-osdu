...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegisterSubscriptionCreateResult', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.RegisterSubscriptionCreateResult();
      });

      it('should create an instance of RegisterSubscriptionCreateResult', function() {
        // TODO: update the code to test RegisterSubscriptionCreateResult
        expect(instance).to.be.a(SelfManagedOsdu.RegisterSubscriptionCreateResult);
      });
