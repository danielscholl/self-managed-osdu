...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SearchQueryResponse', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.SearchQueryResponse();
      });

      it('should create an instance of SearchQueryResponse', function() {
        // TODO: update the code to test SearchQueryResponse
        expect(instance).to.be.a(SelfManagedOsdu.SearchQueryResponse);
      });
