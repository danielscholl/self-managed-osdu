...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegisterLegal', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.RegisterLegal();
      });

      it('should create an instance of RegisterLegal', function() {
        // TODO: update the code to test RegisterLegal
        expect(instance).to.be.a(SelfManagedOsdu.RegisterLegal);
      });
