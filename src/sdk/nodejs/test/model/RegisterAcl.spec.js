...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegisterAcl', function() {
      beforeEach(function() {
        instance = new SelfManagedOsdu.RegisterAcl();
      });

      it('should create an instance of RegisterAcl', function() {
        // TODO: update the code to test RegisterAcl
        expect(instance).to.be.a(SelfManagedOsdu.RegisterAcl);
      });
