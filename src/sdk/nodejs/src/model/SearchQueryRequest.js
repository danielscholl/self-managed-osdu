...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SelfManagedOsdu.SearchQueryRequest = factory(root.SelfManagedOsdu.ApiClient, root.SelfManagedOsdu.SearchSpatialFilter);
  }
}(this, function(ApiClient, SearchSpatialFilter) {
  'use strict';

  /**
   * The SearchQueryRequest model module.
   * @module model/SearchQueryRequest
   * @version 0.11.0
   */

  /**
   * Constructs a new <code>SearchQueryRequest</code>.
   * Json object to query the Search API
   * @alias module:model/SearchQueryRequest
   * @class
  ...
  /**
   * Constructs a <code>SearchQueryRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchQueryRequest} obj Optional instance to populate.
   * @return {module:model/SearchQueryRequest} The populated <code>SearchQueryRequest</code> instance.
   */
