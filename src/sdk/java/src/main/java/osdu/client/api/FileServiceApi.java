...
public class FileServiceApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call publishFileMetadataForAFile_Call(String dataPartitionId, FileMetadata body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call publishFileMetadataForAFile_ValidateBeforeCall(String dataPartitionId, FileMetadata body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public FileMetadataResponse publishFileMetadataForAFile_(String dataPartitionId, FileMetadata body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<FileMetadataResponse> publishFileMetadataForAFile_WithHttpInfo(String dataPartitionId, FileMetadata body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call publishFileMetadataForAFile_Async(String dataPartitionId, FileMetadata body, final ApiCallback<FileMetadataResponse> callback) throws ApiException {
